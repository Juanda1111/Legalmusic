const icons = {
  home: '<circle cx="12" cy="12" r="3"></circle><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle>', // Usando usuario para home, o mejor:
  // home real:
  ...
  guitar: '<path d="M12 18a4 4 0 1 0 0-8 4 4 0 0 0 0 8z"></path><path d="M15 15l6-6-4-4-6 6"></path><circle cx="12" cy="14" r="1"></circle>',
...
// Arreglando el icono de home real
icons.home = '<path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline>';

export const icon = (name, size = 24) => {
  const content = icons[name] || '';
  return `<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-${name}">${content}</svg>`;
};
